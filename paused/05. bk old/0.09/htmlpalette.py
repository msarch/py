...
# custom lists
html_colors = (lightpink, pink , crimson, lavenderblush, palevioletred, \
               hotpink, deeppink, mediumvioletred, orchid, thistle, plum , \
               violet, fuchsia, darkmagenta, purple, mediumorchid, darkviolet,\
               darkorchid, indigo, blueviolet, mediumpurple, mediumslateblue,\
               slateblue, darkslateblue, ghostwhite, lavender, blue ,\
               mediumblue, darkblue, navy , midnightblue, royalblue, \
               cornflowerblue, lightsteelblue, lightslategray, slategray,\
               dodgerblue, aliceblue, steelblue, lightskyblue, skyblue, \
               deepskyblue, lightblue, powderblue, cadetblue, darkturquoise, \
               azure, lightcyan, paleturquoise, aqua , darkcyan, teal ,\
               darkslategray, mediumturquoise, lightseagreen, turquoise,\
               aquamarine, mediumaquamarine, mediumspringgreen, mintcream, \
               springgreen, mediumseagreen, seagreen, honeydew, darkseagreen, \
               palegreen, lightgreen, limegreen, lime , forestgreen, green,\
               darkgreen, lawngreen, chartreuse, greenyellow, darkolivegreen, \
               yellowgreen, olivedrab, ivory, beige, lightyellow, \
               ...
               blanchedalmond, navajowhite, antiquewhite, tan , burlywood, \
               darkorange, bisque, linen, peru , peachpuff, sandybrown, \
               chocolate, saddlebrown, seashell, sienna, lightsalmon, coral, \
               orangered, darksalmon, tomato, salmon, mistyrose, lightcoral, \
               snow , rosybrown, indianred, red , brown, firebrick, darkred, \
               maroon, white, whitesmoke, gainsboro, lightgrey, silver, \
               darkgray, gray , grey , dimgray, dimgrey, black, cyan , \
               transparent, bark)
kapla_colors = (gold,darkgreen,red,orangered,darkblue)
