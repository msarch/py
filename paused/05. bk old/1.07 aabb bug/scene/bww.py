...
from rules import  Slide, Bounce
from utils.cfg import background_color, black, blue, orange, red, Vel, SCREEN, HEIGHT
...
Bounce('screen_bounce', actors=('s1', 's2'), rect=SCREEN)
