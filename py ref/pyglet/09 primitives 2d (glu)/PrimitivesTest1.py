...
import Primitives as primitives # module discussed above
...
class PrimWin(pyglet.window.Window):
    ...
    def __init__(self):
        super(PrimWin, self).__init__(resizable=True,fullscreen=False, caption='Primitives Test!', config=smoothConfig)
        glEnable(GL_BLEND)
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA)
        self.p = primitives.Pixel(10,10)
        self.c = primitives.Circle(200,100,width=500,color=(0.,.9,0.,1.))
